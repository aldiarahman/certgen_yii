...
class KegiatanSearch extends Kegiatan
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['kodekegiatan', 'namakegiatan', 'tanggal_kegiatan', 'penyelenggara', 'file_template'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'kodekegiatan', $this->kodekegiatan])
            ->andFilterWhere(['like', 'namakegiatan', $this->namakegiatan])
            ->andFilterWhere(['like', 'penyelenggara', $this->penyelenggara])
            ->andFilterWhere(['like', 'file_template', $this->file_template]);
